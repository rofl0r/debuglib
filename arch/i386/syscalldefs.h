static const syscalldef syscalldefs[] = {
	...
	[SYSCALL_OR_NUM(223, SYS_security)]	 = MAKE_UINT16(5, 1944),
	[SYSCALL_OR_NUM(224, SYS_gettid)]	 = MAKE_UINT16(0, 1953),
	[SYSCALL_OR_NUM(225, SYS_readahead)]	 = MAKE_UINT16(4, 1960),
	[SYSCALL_OR_NUM(226, SYS_setxattr)]	 = MAKE_UINT16(5, 1970),
	[SYSCALL_OR_NUM(227, SYS_lsetxattr)]	 = MAKE_UINT16(5, 1979),
	[SYSCALL_OR_NUM(228, SYS_fsetxattr)]	 = MAKE_UINT16(5, 1989),
	[SYSCALL_OR_NUM(229, SYS_getxattr)]	 = MAKE_UINT16(4, 1999),
	[SYSCALL_OR_NUM(230, SYS_lgetxattr)]	 = MAKE_UINT16(4, 2008),
	[SYSCALL_OR_NUM(231, SYS_fgetxattr)]	 = MAKE_UINT16(4, 2018),
	[SYSCALL_OR_NUM(232, SYS_listxattr)]	 = MAKE_UINT16(3, 2028),
	[SYSCALL_OR_NUM(233, SYS_llistxattr)]	 = MAKE_UINT16(3, 2038),
	[SYSCALL_OR_NUM(234, SYS_flistxattr)]	 = MAKE_UINT16(3, 2049),
	[SYSCALL_OR_NUM(235, SYS_removexattr)]	 = MAKE_UINT16(2, 2060),
	[SYSCALL_OR_NUM(236, SYS_lremovexattr)]	 = MAKE_UINT16(2, 2072),
	[SYSCALL_OR_NUM(237, SYS_fremovexattr)]	 = MAKE_UINT16(2, 2085),
	[SYSCALL_OR_NUM(238, SYS_tkill)]	 = MAKE_UINT16(2, 2098),
	[SYSCALL_OR_NUM(239, SYS_sendfile64)]	 = MAKE_UINT16(4, 2104),
	[SYSCALL_OR_NUM(240, SYS_futex)]	 = MAKE_UINT16(6, 2115),
	[SYSCALL_OR_NUM(241, SYS_sched_setaffinity)]	 = MAKE_UINT16(3, 2121),
	[SYSCALL_OR_NUM(242, SYS_sched_getaffinity)]	 = MAKE_UINT16(3, 2139),
	[SYSCALL_OR_NUM(243, SYS_set_thread_area)]	 = MAKE_UINT16(1, 2157),
	[SYSCALL_OR_NUM(244, SYS_get_thread_area)]	 = MAKE_UINT16(1, 2173),
	[SYSCALL_OR_NUM(245, SYS_io_setup)]	 = MAKE_UINT16(2, 2189),
	[SYSCALL_OR_NUM(246, SYS_io_destroy)]	 = MAKE_UINT16(1, 2198),
	[SYSCALL_OR_NUM(247, SYS_io_getevents)]	 = MAKE_UINT16(5, 2209),
	[SYSCALL_OR_NUM(248, SYS_io_submit)]	 = MAKE_UINT16(3, 2222),
	[SYSCALL_OR_NUM(249, SYS_io_cancel)]	 = MAKE_UINT16(3, 2232),
	[SYSCALL_OR_NUM(250, SYS_fadvise64)]	 = MAKE_UINT16(5, 2242),
	[SYSCALL_OR_NUM(252, SYS_exit_group)]	 = MAKE_UINT16(1, 2252),
	[SYSCALL_OR_NUM(253, SYS_lookup_dcookie)]	 = MAKE_UINT16(4, 2263),
	[SYSCALL_OR_NUM(254, SYS_epoll_create)]	 = MAKE_UINT16(1, 2278),
	[SYSCALL_OR_NUM(255, SYS_epoll_ctl)]	 = MAKE_UINT16(4, 2291),
	[SYSCALL_OR_NUM(256, SYS_epoll_wait)]	 = MAKE_UINT16(4, 2301),
	[SYSCALL_OR_NUM(257, SYS_remap_file_pages)]	 = MAKE_UINT16(5, 2312),
	[SYSCALL_OR_NUM(258, SYS_set_tid_address)]	 = MAKE_UINT16(1, 2329),
	[SYSCALL_OR_NUM(259, SYS_timer_create)]	 = MAKE_UINT16(3, 2345),
	[SYSCALL_OR_NUM(260, SYS_timer_settime)]	 = MAKE_UINT16(4, 2358),
	[SYSCALL_OR_NUM(261, SYS_timer_gettime)]	 = MAKE_UINT16(2, 2372),
	[SYSCALL_OR_NUM(262, SYS_timer_getoverrun)]	 = MAKE_UINT16(1, 2386),
	[SYSCALL_OR_NUM(263, SYS_timer_delete)]	 = MAKE_UINT16(1, 2403),
	[SYSCALL_OR_NUM(264, SYS_clock_settime)]	 = MAKE_UINT16(2, 2416),
	[SYSCALL_OR_NUM(265, SYS_clock_gettime)]	 = MAKE_UINT16(2, 2430),
	[SYSCALL_OR_NUM(266, SYS_clock_getres)]	 = MAKE_UINT16(2, 2444),
	[SYSCALL_OR_NUM(267, SYS_clock_nanosleep)]	 = MAKE_UINT16(4, 2457),
	[SYSCALL_OR_NUM(268, SYS_statfs64)]	 = MAKE_UINT16(3, 2473),
	[SYSCALL_OR_NUM(269, SYS_fstatfs64)]	 = MAKE_UINT16(3, 2482),
	[SYSCALL_OR_NUM(270, SYS_tgkill)]	 = MAKE_UINT16(3, 2492),
	[SYSCALL_OR_NUM(271, SYS_utimes)]	 = MAKE_UINT16(2, 2499),
	[SYSCALL_OR_NUM(272, SYS_fadvise64_64)]	 = MAKE_UINT16(6, 2506),
	[SYSCALL_OR_NUM(273, SYS_vserver)]	 = MAKE_UINT16(5, 2519),
	[SYSCALL_OR_NUM(274, SYS_mbind)]	 = MAKE_UINT16(6, 2527),
	[SYSCALL_OR_NUM(275, SYS_get_mempolicy)]	 = MAKE_UINT16(5, 2533),
	[SYSCALL_OR_NUM(276, SYS_set_mempolicy)]	 = MAKE_UINT16(3, 2547),
	[SYSCALL_OR_NUM(277, SYS_mq_open)]	 = MAKE_UINT16(4, 2561),
	[SYSCALL_OR_NUM(278, SYS_mq_unlink)]	 = MAKE_UINT16(1, 2569),
	[SYSCALL_OR_NUM(279, SYS_mq_timedsend)]	 = MAKE_UINT16(5, 2579),
	[SYSCALL_OR_NUM(280, SYS_mq_timedreceive)]	 = MAKE_UINT16(5, 2592),
	[SYSCALL_OR_NUM(281, SYS_mq_notify)]	 = MAKE_UINT16(2, 2608),
	[SYSCALL_OR_NUM(282, SYS_mq_getsetattr)]	 = MAKE_UINT16(3, 2618),
	[SYSCALL_OR_NUM(283, SYS_kexec_load)]	 = MAKE_UINT16(4, 2632),
	[SYSCALL_OR_NUM(284, SYS_waitid)]	 = MAKE_UINT16(5, 2643),
	[SYSCALL_OR_NUM(286, SYS_add_key)]	 = MAKE_UINT16(5, 2650),
	[SYSCALL_OR_NUM(287, SYS_request_key)]	 = MAKE_UINT16(4, 2658),
	[SYSCALL_OR_NUM(288, SYS_keyctl)]	 = MAKE_UINT16(5, 2670),
	[SYSCALL_OR_NUM(289, SYS_ioprio_set)]	 = MAKE_UINT16(3, 2677),
	[SYSCALL_OR_NUM(290, SYS_ioprio_get)]	 = MAKE_UINT16(2, 2688),
	[SYSCALL_OR_NUM(291, SYS_inotify_init)]	 = MAKE_UINT16(0, 2699),
	[SYSCALL_OR_NUM(292, SYS_inotify_add_watch)]	 = MAKE_UINT16(3, 2712),
	[SYSCALL_OR_NUM(293, SYS_inotify_rm_watch)]	 = MAKE_UINT16(2, 2730),
	[SYSCALL_OR_NUM(294, SYS_migrate_pages)]	 = MAKE_UINT16(4, 2747),
	[SYSCALL_OR_NUM(295, SYS_openat)]	 = MAKE_UINT16(4, 2761),
	[SYSCALL_OR_NUM(296, SYS_mkdirat)]	 = MAKE_UINT16(3, 2768),
	[SYSCALL_OR_NUM(297, SYS_mknodat)]	 = MAKE_UINT16(4, 2776),
	[SYSCALL_OR_NUM(298, SYS_fchownat)]	 = MAKE_UINT16(5, 2784),
	[SYSCALL_OR_NUM(299, SYS_futimesat)]	 = MAKE_UINT16(3, 2793),
	[SYSCALL_OR_NUM(300, SYS_fstatat64)]	 = MAKE_UINT16(4, 2803),
	[SYSCALL_OR_NUM(301, SYS_unlinkat)]	 = MAKE_UINT16(3, 2813),
	[SYSCALL_OR_NUM(302, SYS_renameat)]	 = MAKE_UINT16(4, 2822),
	[SYSCALL_OR_NUM(303, SYS_linkat)]	 = MAKE_UINT16(5, 2831),
	[SYSCALL_OR_NUM(304, SYS_symlinkat)]	 = MAKE_UINT16(3, 2838),
	[SYSCALL_OR_NUM(305, SYS_readlinkat)]	 = MAKE_UINT16(4, 2848),
	[SYSCALL_OR_NUM(306, SYS_fchmodat)]	 = MAKE_UINT16(3, 2859),
	[SYSCALL_OR_NUM(307, SYS_faccessat)]	 = MAKE_UINT16(3, 2868),
	[SYSCALL_OR_NUM(308, SYS_pselect6)]	 = MAKE_UINT16(6, 2878),
	[SYSCALL_OR_NUM(309, SYS_ppoll)]	 = MAKE_UINT16(5, 2887),
	[SYSCALL_OR_NUM(310, SYS_unshare)]	 = MAKE_UINT16(1, 2893),
	[SYSCALL_OR_NUM(311, SYS_set_robust_list)]	 = MAKE_UINT16(2, 2901),
	[SYSCALL_OR_NUM(312, SYS_get_robust_list)]	 = MAKE_UINT16(3, 2917),
	[SYSCALL_OR_NUM(313, SYS_splice)]	 = MAKE_UINT16(6, 2933),
	[SYSCALL_OR_NUM(314, SYS_sync_file_range)]	 = MAKE_UINT16(4, 2940),
	[SYSCALL_OR_NUM(315, SYS_tee)]	 = MAKE_UINT16(4, 2956),
	[SYSCALL_OR_NUM(316, SYS_vmsplice)]	 = MAKE_UINT16(4, 2960),
	[SYSCALL_OR_NUM(317, SYS_move_pages)]	 = MAKE_UINT16(6, 2969),
	[SYSCALL_OR_NUM(318, SYS_getcpu)]	 = MAKE_UINT16(3, 2980),
	[SYSCALL_OR_NUM(319, SYS_epoll_pwait)]	 = MAKE_UINT16(6, 2987),
	[SYSCALL_OR_NUM(320, SYS_utimensat)]	 = MAKE_UINT16(4, 2999),
	[SYSCALL_OR_NUM(321, SYS_signalfd)]	 = MAKE_UINT16(3, 3009),
	[SYSCALL_OR_NUM(322, SYS_timerfd_create)]	 = MAKE_UINT16(2, 3018),
	[SYSCALL_OR_NUM(323, SYS_eventfd)]	 = MAKE_UINT16(1, 3033),
	[SYSCALL_OR_NUM(324, SYS_fallocate)]	 = MAKE_UINT16(6, 3041),
	[SYSCALL_OR_NUM(325, SYS_timerfd_settime)]	 = MAKE_UINT16(4, 3051),
	[SYSCALL_OR_NUM(326, SYS_timerfd_gettime)]	 = MAKE_UINT16(2, 3067),
	[SYSCALL_OR_NUM(327, SYS_signalfd4)]	 = MAKE_UINT16(4, 3083),
	[SYSCALL_OR_NUM(328, SYS_eventfd2)]	 = MAKE_UINT16(2, 3093),
	[SYSCALL_OR_NUM(329, SYS_epoll_create1)]	 = MAKE_UINT16(1, 3102),
	[SYSCALL_OR_NUM(330, SYS_dup3)]	 = MAKE_UINT16(3, 3116),
	[SYSCALL_OR_NUM(331, SYS_pipe2)]	 = MAKE_UINT16(2, 3121),
	[SYSCALL_OR_NUM(332, SYS_inotify_init1)]	 = MAKE_UINT16(1, 3127),
	[SYSCALL_OR_NUM(333, SYS_preadv)]	 = MAKE_UINT16(5, 3141),
	[SYSCALL_OR_NUM(334, SYS_pwritev)]	 = MAKE_UINT16(5, 3148),
	[SYSCALL_OR_NUM(335, SYS_rt_tgsigqueueinfo)]	 = MAKE_UINT16(4, 3156),
	[SYSCALL_OR_NUM(336, SYS_perf_event_open)]	 = MAKE_UINT16(5, 3174),
	[SYSCALL_OR_NUM(337, SYS_recvmmsg)]	 = MAKE_UINT16(5, 3190),
	[SYSCALL_OR_NUM(338, SYS_fanotify_init)]	 = MAKE_UINT16(2, 3199),
	[SYSCALL_OR_NUM(339, SYS_fanotify_mark)]	 = MAKE_UINT16(5, 3213),
	[SYSCALL_OR_NUM(340, SYS_prlimit64)]	 = MAKE_UINT16(4, 3227),
	[SYSCALL_OR_NUM(341, SYS_name_to_handle_at)]	 = MAKE_UINT16(5, 3237),
	[SYSCALL_OR_NUM(342, SYS_open_by_handle_at)]	 = MAKE_UINT16(3, 3255),
	[SYSCALL_OR_NUM(343, SYS_clock_adjtime)]	 = MAKE_UINT16(2, 3273),
	[SYSCALL_OR_NUM(344, SYS_syncfs)]	 = MAKE_UINT16(1, 3287),
	[SYSCALL_OR_NUM(345, SYS_sendmmsg)]	 = MAKE_UINT16(4, 3294),
	[SYSCALL_OR_NUM(346, SYS_setns)]	 = MAKE_UINT16(2, 3303),
	[SYSCALL_OR_NUM(347, SYS_process_vm_readv)]	 = MAKE_UINT16(6, 3309),
	[SYSCALL_OR_NUM(348, SYS_process_vm_writev)]	 = MAKE_UINT16(6, 3326),
	[SYSCALL_OR_NUM(400, SYS_socket_subcall)]	 = MAKE_UINT16(6, 3344),
	[SYSCALL_OR_NUM(401, SYS_socket)]	 = MAKE_UINT16(3, 3359),
	[SYSCALL_OR_NUM(402, SYS_bind)]	 = MAKE_UINT16(3, 3366),
	[SYSCALL_OR_NUM(403, SYS_connect)]	 = MAKE_UINT16(3, 3371),
	[SYSCALL_OR_NUM(404, SYS_listen)]	 = MAKE_UINT16(2, 3379),
	[SYSCALL_OR_NUM(405, SYS_accept)]	 = MAKE_UINT16(3, 3386),
	[SYSCALL_OR_NUM(406, SYS_getsockname)]	 = MAKE_UINT16(3, 3393),
	[SYSCALL_OR_NUM(407, SYS_getpeername)]	 = MAKE_UINT16(3, 3405),
	[SYSCALL_OR_NUM(408, SYS_socketpair)]	 = MAKE_UINT16(4, 3417),
	[SYSCALL_OR_NUM(409, SYS_send)]	 = MAKE_UINT16(4, 3428),
	[SYSCALL_OR_NUM(410, SYS_recv)]	 = MAKE_UINT16(4, 3433),
	[SYSCALL_OR_NUM(411, SYS_sendto)]	 = MAKE_UINT16(6, 3438),
	[SYSCALL_OR_NUM(412, SYS_recvfrom)]	 = MAKE_UINT16(6, 3445),
	[SYSCALL_OR_NUM(413, SYS_shutdown)]	 = MAKE_UINT16(2, 3454),
	[SYSCALL_OR_NUM(414, SYS_setsockopt)]	 = MAKE_UINT16(5, 3463),
	[SYSCALL_OR_NUM(415, SYS_getsockopt)]	 = MAKE_UINT16(5, 3474),
	[SYSCALL_OR_NUM(416, SYS_sendmsg)]	 = MAKE_UINT16(3, 3485),
	[SYSCALL_OR_NUM(417, SYS_recvmsg)]	 = MAKE_UINT16(5, 3493),
	[SYSCALL_OR_NUM(418, SYS_accept4)]	 = MAKE_UINT16(4, 3501),
	[SYSCALL_OR_NUM(419, SYS_recvmmsg)]	 = MAKE_UINT16(5, 3509),
	[SYSCALL_OR_NUM(420, SYS_ipc_subcall)]	 = MAKE_UINT16(4, 3518),
	[SYSCALL_OR_NUM(421, SYS_semop)]	 = MAKE_UINT16(4, 3530),
	[SYSCALL_OR_NUM(422, SYS_semget)]	 = MAKE_UINT16(4, 3536),
	[SYSCALL_OR_NUM(423, SYS_semctl)]	 = MAKE_UINT16(4, 3543),
	[SYSCALL_OR_NUM(424, SYS_semtimedop)]	 = MAKE_UINT16(5, 3550),
	[SYSCALL_OR_NUM(425, SYS_ipc_subcall)]	 = MAKE_UINT16(4, 3561),
	[SYSCALL_OR_NUM(426, SYS_ipc_subcall)]	 = MAKE_UINT16(4, 3573),
	[SYSCALL_OR_NUM(427, SYS_ipc_subcall)]	 = MAKE_UINT16(4, 3585),
	[SYSCALL_OR_NUM(428, SYS_ipc_subcall)]	 = MAKE_UINT16(4, 3597),
	[SYSCALL_OR_NUM(429, SYS_ipc_subcall)]	 = MAKE_UINT16(4, 3609),
	[SYSCALL_OR_NUM(430, SYS_ipc_subcall)]	 = MAKE_UINT16(4, 3621),
	[SYSCALL_OR_NUM(431, SYS_msgsnd)]	 = MAKE_UINT16(4, 3633),
	[SYSCALL_OR_NUM(432, SYS_msgrcv)]	 = MAKE_UINT16(4, 3640),
	[SYSCALL_OR_NUM(433, SYS_msgget)]	 = MAKE_UINT16(4, 3647),
	[SYSCALL_OR_NUM(434, SYS_msgctl)]	 = MAKE_UINT16(4, 3654),
	[SYSCALL_OR_NUM(435, SYS_ipc_subcall)]	 = MAKE_UINT16(4, 3661),
	[SYSCALL_OR_NUM(436, SYS_ipc_subcall)]	 = MAKE_UINT16(4, 3673),
	[SYSCALL_OR_NUM(437, SYS_ipc_subcall)]	 = MAKE_UINT16(4, 3685),
	[SYSCALL_OR_NUM(438, SYS_ipc_subcall)]	 = MAKE_UINT16(4, 3697),
	[SYSCALL_OR_NUM(439, SYS_ipc_subcall)]	 = MAKE_UINT16(4, 3709),
	[SYSCALL_OR_NUM(440, SYS_ipc_subcall)]	 = MAKE_UINT16(4, 3721),
	[SYSCALL_OR_NUM(441, SYS_shmat)]	 = MAKE_UINT16(4, 3733),
	[SYSCALL_OR_NUM(442, SYS_shmdt)]	 = MAKE_UINT16(4, 3739),
	[SYSCALL_OR_NUM(443, SYS_shmget)]	 = MAKE_UINT16(4, 3745),
	[SYSCALL_OR_NUM(444, SYS_shmctl)]	 = MAKE_UINT16(4, 3752),
};
...
/*
longest string: 22
total concatenated string length: 3758
pointer overhead: 3128
strings + overhead: 6886
total size aligned to max strlen 8993
*/
